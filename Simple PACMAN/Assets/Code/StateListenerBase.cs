...
public abstract class StateListenerBase : MonoBehaviour 
{
    ...
    {
        if(StateManager.Instance) StateManager.Instance.OnStateChanged += OnStateChangedHandler;
        else throw new NullReferenceException("StateManager.Instance is null.");
    }
